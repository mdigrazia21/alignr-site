...
export function ProblemSection() {
  return <section className="w-full py-24 bg-slate-50">
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-medium tracking-[-2px] leading-tight font-dm-sans mb-6">The problem with hiring today</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {["Spending too much on traditional recruitment agencies", "Not getting great talent", "Stressed about having to do hiring yourself and falling behind", "Lost confidence & team productivity due to a recent bad hire"].map((problem, index) => <Card key={index} className="overflow-hidden rounded-2xl shadow-sm transition-all duration-300 hover:shadow-md">
